...
### Individual Project
Documentation: Individual Project (indiv_veg) is looking into high leaf index in the Amazon Rainforest between 1950-2025. It finds the difference between the start of 1950 and 2025 to see how/if there have been noteworthy change to high leaf index over the 75 years. It imports functions from fun_gridded. See AI statement below.
...
- import_code: KRDU dataset, function to print column data
...
- scatter_KRDU: Scatterplot Raleigh-Durham Airport
- testrun_envdata: South Platte River, CO, monthly mean of cfs graphed
- testrun_encdata2: Fire perimeters in CO, using geopandas (unfinished)
